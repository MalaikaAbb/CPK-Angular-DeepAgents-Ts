...
Copilot Runtime  ·  localhost:8200        &#8592; Node, frontend/server.ts
  ...
  v
DeepAgents graph  ·  localhost:2024       &#8592; TypeScript / LangGraph server
  &#124;  createDeepAgent(&#123; model, tools, middleware &#125;) as "sample_agent"
  v
Model  (gpt-5.4)</code></pre>
      ...
      <ui-callout title="Both backends must be running">
        ...
        graph with <code>npx &#64;langchain/langgraph-cli dev</code> from
        <code>backend/</code>, and the runtime with <code>npm run runtime</code>
